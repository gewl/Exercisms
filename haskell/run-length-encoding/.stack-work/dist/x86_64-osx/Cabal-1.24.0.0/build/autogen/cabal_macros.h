...
#define CURRENT_COMPONENT_ID "run-length-encoding-0.0.0-FyHcxGrdAH29H6gjJRsd6l"

#define CURRENT_PACKAGE_KEY "run-length-encoding-0.0.0-FyHcxGrdAH29H6gjJRsd6l"
